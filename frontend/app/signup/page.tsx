    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-12 animate-fade-in-up">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-green-400 to-green-500 mb-6 shadow-lg">
        ...
        <div className="modern-card-lg animate-scale-in stagger-1">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="modern-btn-success w-full px-8 py-4 text-base disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
